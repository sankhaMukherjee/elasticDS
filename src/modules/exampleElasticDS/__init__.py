'''This module tests the hyperparameter tuning of a simple linear model
...
Make sure that the appropriate ElasticSearch server is running. 
...
.. code-block:: python
    ...
    "moduleName" : "exampleElasticDS",
    "path"       : "modules/exampleElasticDS/exampleElasticDS.py",
    "execute"    : true,
    "description": "",
    "owner"      : ""
